...
<body>
  <div class="container-fliud">
    <div class="row center-xs center-sm center-md center-lg major-row">
      ...
      <!--<div class="row major-row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <form class="search_field" action="" method="POST">
            ...
            <div class="chatBox">
              <div class="chatLog">
                ...
                if (isset($_POST['submit_search'])) {
                  ...
                  WHERE users_account.first_name LIKE '%$search%' OR users_account.last_name LIKE '%$search%'";
                  ...
                  if ($queryResult > 0) {
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      echo "<div class='user-photo'> <img src='uploaded_images/".$row['profilePicture']."' > </div>";
                      echo "<p class='chat-message'>".$row['first_name']." ".$row['last_name']."</p>";
                      echo "</div>";
                    }
                  } else {
