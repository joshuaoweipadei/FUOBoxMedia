            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      All Users registered on the the website.
                    </p>
                    ...
                    echo '<thead>
                          ...
                          while ($row = mysqli_fetch_array($query)) {
                            ...
                            if ($row['emailVerified'] == 1) {
                              $emailVerified = "<span style='color:#00cc00'>Yes</span>";
                            } else {
                              $emailVerified = "<span style='color:#ff0000'>No</span>";
                            }

                            if ($row['active'] == 1) {
                              $activeUser = "<i class='fa fa-circle' style='color:#00cc00'></i>";
                            } else {
                              $activeUser = "<i class='fa fa-circle' style='color:#ff0000'></i>";
                            }
                      echo '<tbody>
                              <tr>
                                <td>'.$i.'</td>
